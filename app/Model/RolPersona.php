...
App::uses('AppModel','Model');
  class RolPersona extends AppModel {
    ...
    public function agregarRolPersona($persona_id, $role_id){
    	...
    	$this->data['RolPersona']['rol_id'] = $role_id;
    ...
    public function listFindRoles($order_by='RolPersona.id', $order='DESC', $persona_id=0, $start=0, $per_page=10) {
    		$arr_obj_persona = $this->findObjects('all',array(
    				'joins' => array(
    						array(
    								'table' => 'roles',
    								...
    								'type' => 'INNER',
    								'conditions' => array(
    										'RolesJoin.id = RolPersona.rol_id'
    								)
    						)
    				),
    				'conditions'=>array(
