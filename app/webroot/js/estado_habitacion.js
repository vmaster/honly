$(document).ready(function(){
	...
	$body.off('keypress','div#div-crear-estado-habitacion #txtEstadoHabitacioneMant');
	$body.on('keypress','div#div-crear-estado-habitacion #txtEstadoHabitacioneMant',function(e){
		if(e.which === 13) {
			estado_habitacion.saveEstadoHabitacioneMantenimiento();
			return false;
		}
