	...
	<section>
		<div class="row">
			<div class="span3">
				<label><?php echo __('Tipo Persona'); ?> </label> <select
					name="data[Persona][tipo_persona_id]" class="cboTipoPersonas" id ="cbo-tipo-personas">
					<?php 
			...
			<div class="span3">
				<label><?php echo utf8_encode(__('Tipo Documento')); ?> </label> <select
					class="cboNroDocumento" id="cboNroDocumento"
			...
			<div class="span3">
				...
				<?php echo $this->Form->input('nro_documento', array('id' =>'PersonaNroDocumento', 'div' => false, 'label' => false)); ?>
			</div>
		</div>
		<div class="row">
			<div class="span3">
				...
				<?php echo $this->Form->input('nombre', array('div' => false, 'label' => false, 'class'=> 'txtNombre','id' =>'txtNombre')); ?>
			</div>
			<div class="span3">
				<?php echo "<label  id='lblApellido'>".__('Apellidos')."</label>"; ?>
				<?php echo $this->Form->input('apellido', array('div' => false, 'label' => false, 'class'=> 'txtApellido','id' =>'txtApellido')); ?>
			</div>
			<div class="span3">
				<?php echo "<label  id='lblSexo'>".__('Sexo')."</label>"; ?>
				<select name="data[Persona][sexo]" class="cboSexo" id = "cboSexo">
					<?php
		...
		<div class="row">
			...
			<div class="span3">
				...
				<select disabled class="cboProvincia">
					<option selected="selected">
						--
			...
			<div class="span3">
				...
				<select disabled name="data[Persona][distrito_id]" class="cboDistrito">
		...
		<div class="row">
			<div class="span3">
				...
				<select name="data[Persona][estado_civil_id]" class="cboEstadoCivil"
					id="cboEstadoCivil">
					<?php 
			...
			<div class="span3">
				...
				?>
				<input name="data[Persona][fec_nac]" class="txtFechaNacimiento" id="txtFechaNacimiento" placeholder="dd-mm-aaaa" type="text" value="<?php if(isset($obj_persona)){ echo $fec_nac;}?>">
			...
			<div class="span3">
				...
				<?php echo $this->Form->input('email', array('id' =>'txtCorreo','class' =>'txtCorreo','div' => false, 'label' => false,'placeholder' =>'email')); ?>
			</div>
		</div>
		<div class="row">
			<div class="span3">
				<?php echo "<label>".utf8_encode(__('Dirección'))."</label>"; ?>
				<?php echo $this->Form->input('direccion', array('id' =>'txtDireccion','class' =>'txtDireccion','div' => false, 'label' => false,'placeholder' => utf8_encode(__("dirección")))); ?>
			</div>
			<div class="span3">
				<?php echo "<label>".utf8_encode(__('Teléfono/Celular'))."</label>"; ?>
				<?php echo $this->Form->input('telefono', array('id' =>'txtTelefono','class' =>'txtTelefono','div' => false, 'label' => false,'placeholder' => utf8_encode(__("teléfono")))); ?>
				<?php echo $this->Form->input('celular', array('id' =>'txtMovil','class' =>'txtMovil','div' => false, 'label' => false,'placeholder' => utf8_encode(__("móvil")))); ?>
			</div>
			<div class="span3">
			<?php if(!isset($persona_id) || ($persona_id == 0)){ ?>
				<?php echo "<label>".__('Rol persona')."</label>"; ?>
				<select name="data[Persona][rol_id]" class="cboRol">
					<?php 
					if(isset($list_all_roles)){
		
					foreach ($list_all_roles as $list_all_rol):
					if(isset($obj_persona) || isset($persona_id)){
						if($list_all_rol->getAttr('id') == $obj_persona->getAttr('rol_id')){
							$selected = " selected = 'selected'";
						}else{
							$selected = "";
						}
