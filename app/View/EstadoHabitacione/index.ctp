...
<div class="content">
	...
	-->
		...
		<div class="modal fade" id="myModalDeleteEstadoHabitacion" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" estado_habitacion_id=''>
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-footer">
						...
						<button class="btn btn-danger eliminar-estado-habitacion-trigger" data-dismiss="modal"><?php echo __('Aceptar'); ?></button>
					</div>
				</div>
			</div>
		</div>
