...
<div id="container_page">
	<div class="data">
		<table class="table" id="table_content_personas">
			...
			?>
			<tbody>
					<tr class="persona_row_container" persona_id="<?php echo $persona->getAttr('id'); ?>" persona_nombre="<?php echo utf8_encode($persona->getAttr('nombre')).' '. utf8_encode($persona->getAttr('apellido')); ?>" tipo_persona_id = "<?php echo $persona->getAttr('tipo_persona_id');?>">
						<td><?php echo $n; ?></td>
