<div class="sidebar-nav">
        ...
        <a href="#accounts-menu" class="nav-header" data-toggle="collapse"><i class="icon-briefcase"></i>Mi Perfil<span class="label label-info">+3</span></a>
        ...
        <a href="#legal-menu" class="nav-header" data-toggle="collapse"><i class="icon-legal"></i>Alquiler</a>
